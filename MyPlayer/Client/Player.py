...
class Player(Client):
    ...
    """
    def __init__(self, master, server_rtsp_port, server_plp_port, rtp_port, plp_port):
        Client.__init__(self, server_rtsp_port, server_plp_port, rtp_port, plp_port)
    ...
    def createWidgets(self):
        ...
        # slider
        f2 = Frame(self.master, height=20, width=800)
        f2.pack_propagate(0)
        f2.place(x=5, y=610)
